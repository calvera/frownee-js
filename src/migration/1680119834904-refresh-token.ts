...
export class user1680119834904 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "refresh_token" ("token" character varying(32) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "validUntil" TIMESTAMP NOT NULL, "userId" uuid, CONSTRAINT "PK_c31d0a2f38e6e99110df62ab0af" PRIMARY KEY ("token"))`);
